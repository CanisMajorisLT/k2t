...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatsWrap = module.exports = React.createClass({
		...
		render: function render() {
			var data = this.props.dataCenter.rawData.queryData.byId(this.props.gameId);
			return React.createElement(
				"div",
				null,
...
/***/ function(module, exports) {
	...
	var TextDataCenter = (function () {
	    function TextDataCenter(server) {
	        _classCallCheck(this, TextDataCenter);

	        this.server = server;
	    }

	    _createClass(TextDataCenter, [{
	        key: "getRandomText",
	        value: function getRandomText() {}
	    }, {
	        key: "getTextById",
	        value: function getTextById() {}
	    }]);
			...
			value: function query() {
				...
				return {
					byId: function byId(itemId) {
						if (_this2.container.hasOwnProperty(itemId)) return Object.assign({}, _this2.container[itemId]);else return null;
					},
					all: function all() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(197).core;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(197)
	  ...
	  , $def             = __webpack_require__(204)
	  , invoke           = __webpack_require__(206)
	  , arrayMethod      = __webpack_require__(207)
	  , IE_PROTO         = __webpack_require__(203).safe('__proto__')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(198)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(197)
	  , TAG      = __webpack_require__(201)('toStringTag')
	  , toString = {}.toString;
	function cof(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(197).g
	  , store  = __webpack_require__(202)('wks');
	module.exports = function(name){
	  return store[name] || (store[name] =
	    global.Symbol && global.Symbol[name] || __webpack_require__(203).safe('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	uid.safe = __webpack_require__(197).g.Symbol || uid;
	module.exports = uid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $   = __webpack_require__(197)
	  ...
	  , SRC = __webpack_require__(203).safe('src')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(197)
	  , setTag   = __webpack_require__(200).set
	...
	$.each.call((
	    ...
	    var sym = __webpack_require__(201)(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Object', {assign: __webpack_require__(218)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(200)
	  , tmp = {};
	tmp[__webpack_require__(201)('toStringTag')] = 'z';
	if(__webpack_require__(197).FW && cof(tmp) != 'z'){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $             = __webpack_require__(197)
	  , HAS_INSTANCE  = __webpack_require__(201)('hasInstance')
	  , FunctionProto = Function.prototype;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && !($Number('0o1') && $Number('0b1'))){
	  ...
	  __webpack_require__(205)($.g, NUMBER, $Number);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def    = __webpack_require__(204)
	  , toIndex = __webpack_require__(197).toIndex
...
/***/ function(module, exports, __webpack_require__) {
	...
	var set   = __webpack_require__(197).set
	  , $at   = __webpack_require__(233)(true)
	  , ITER  = __webpack_require__(203).safe('iter')
	  , $iter = __webpack_require__(234)
	  , step  = $iter.step;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(197)
	  ...
	  , assert            = __webpack_require__(209)
	  , assertObject      = assert.obj
	  , SYMBOL_ITERATOR   = __webpack_require__(201)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * !__webpack_require__(244)(function(iter){ Array.from(iter); }), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(201)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(197)
	  , setUnscope = __webpack_require__(247)
	  , ITER       = __webpack_require__(203).safe('iter')
	  , $iter      = __webpack_require__(234)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
	...
	__webpack_require__(235)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UNSCOPABLES = __webpack_require__(201)('unscopables');
	if(!(UNSCOPABLES in []))__webpack_require__(197).hide(Array.prototype, UNSCOPABLES, {});
	module.exports = function(key){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $       = __webpack_require__(197)
	  , SPECIES = __webpack_require__(201)('species');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(247)('copyWithin');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && $.DESC){
	  if(!CORRECT_NEW || !ALLOWS_RE_WITH_FLAGS){
	    ...
	    __webpack_require__(205)($.g, 'RegExp', $RegExp);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(197)
	  ...
	  , SPECIES  = __webpack_require__(201)('species')
	  , RECORD   = __webpack_require__(203).safe('record')
	  , PROMISE  = 'Promise'
	  , global   = $.g
	  , process  = global.process
	  , isNode   = cof(process) == 'process'
	  , asap     = process && process.nextTick || __webpack_require__(257).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(244)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(208)
	  , get  = __webpack_require__(234).get
	  , call = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.1 Map Objects
	__webpack_require__(261)('Map', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(197)
	  , ctx      = __webpack_require__(208)
	  , safe     = __webpack_require__(203).safe
	  , assert   = __webpack_require__(209)
	  , forOf    = __webpack_require__(256)
	  , step     = __webpack_require__(234).step
	  , $has     = $.has
	  , set      = $.set
	  , isObject = $.isObject
	  , hide     = $.hide
	...
	module.exports = {
	  getConstructor: function(wrapper, NAME, IS_MAP, ADDER){
	    ...
	    __webpack_require__(258)(C.prototype, {
	  ...
	  setIter: function(C, NAME, IS_MAP){
	    __webpack_require__(235)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $     = __webpack_require__(197)
	  , $def  = __webpack_require__(204)
	  , BUGGY = __webpack_require__(234).BUGGY
	  , forOf = __webpack_require__(256)
	  , species = __webpack_require__(249)
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  ...
	  if(!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)){
	    ...
	    __webpack_require__(258)(C.prototype, methods);
	  } else {
	    var inst  = new C
	      , chain = inst[ADDER](IS_WEAK ? {} : -0, 1)
	      , buggyZero;
	    // wrap for init collections from iterable
	    if(!__webpack_require__(244)(function(iter){ new C(iter); })){ // eslint-disable-line no-new
	  ...
	  __webpack_require__(200).set(C, NAME);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	__webpack_require__(261)('Set', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = __webpack_require__(261)('WeakMap', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(197)
	  ...
	  , $iter     = __webpack_require__(234)
	  , ITERATOR  = __webpack_require__(201)('iterator')
	  , ITER      = __webpack_require__(203).safe('iter')
	  , step      = $iter.step
	  , assert    = __webpack_require__(209)
	  , isObject  = $.isObject
	...
	var reflect = {
	  ...
	  ownKeys: __webpack_require__(267),
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(247)('includes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(204);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(211)(/[\\^$*+?.()|[\]{}]/g, '\\$&', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call(keys.split(','), function(key){
	    ...
	    else if(key in [])statics[key] = __webpack_require__(208)(Function.call, [][key], length);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(246);
	var $           = __webpack_require__(197)
	  , Iterators   = __webpack_require__(234).Iterators
	  , ITERATOR    = __webpack_require__(201)('iterator')
