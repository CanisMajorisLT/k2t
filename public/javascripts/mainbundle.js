...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneGameStats = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var dateString = new Date(Number(dateInSeconds)).toString();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(192).core;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(192)
	  ...
	  , cof              = __webpack_require__(195)
	  , $def             = __webpack_require__(199)
	  , invoke           = __webpack_require__(201)
	  , arrayMethod      = __webpack_require__(202)
	  , IE_PROTO         = __webpack_require__(198).safe('__proto__')
	  , assert           = __webpack_require__(204)
	...
	$def($def.P, 'String', {trim: __webpack_require__(206)(/^\s*([\s\S]*\S)?\s*$/, '$1')});
	...
	var date       = new Date(-5e13 - 1)
	  , brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z'
	      && __webpack_require__(207)(function(){ new Date(NaN).toISOString(); }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(193)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(192).g
	  , store  = __webpack_require__(197)('wks');
	module.exports = function(name){
	  return store[name] || (store[name] =
	    global.Symbol && global.Symbol[name] || __webpack_require__(198).safe('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	uid.safe = __webpack_require__(192).g.Symbol || uid;
	module.exports = uid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $   = __webpack_require__(192)
	  ...
	  , SRC = __webpack_require__(198).safe('src')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertFunction = __webpack_require__(204).fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(192)
	  , setTag   = __webpack_require__(195).set
	  ...
	  , assertObject = __webpack_require__(204).obj
	  , ObjectProto = Object.prototype
	  , DESC     = $.DESC
	  , has      = $.has
	  , $create  = $.create
	...
	$.each.call((
	    ...
	    var sym = __webpack_require__(196)(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(199);
	$def($def.S, 'Object', {assign: __webpack_require__(213)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(199);
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(217).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(195)
	  , tmp = {};
	tmp[__webpack_require__(196)('toStringTag')] = 'z';
	if(__webpack_require__(192).FW && cof(tmp) != 'z'){
	  __webpack_require__(200)(Object.prototype, 'toString', function toString(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && !($Number('0o1') && $Number('0b1'))){
	  ...
	  __webpack_require__(200)($.g, NUMBER, $Number);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def    = __webpack_require__(199)
	  , toIndex = __webpack_require__(192).toIndex
...
/***/ function(module, exports, __webpack_require__) {
	...
	var set   = __webpack_require__(192).set
	  , $at   = __webpack_require__(228)(true)
	  , ITER  = __webpack_require__(198).safe('iter')
	  , $iter = __webpack_require__(229)
	  , step  = $iter.step;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(192)
	  ...
	  , assert            = __webpack_require__(204)
	  , assertObject      = assert.obj
	  , SYMBOL_ITERATOR   = __webpack_require__(196)('iterator')
	  , FF_ITERATOR       = '@@iterator'
	  , Iterators         = __webpack_require__(197)('iterators')
	  , IteratorPrototype = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P + $def.F * !__webpack_require__(207)(function(){ 'q'.endsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// should throw error on regex
	$def($def.P + $def.F * !__webpack_require__(207)(function(){ 'q'.startsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * !__webpack_require__(239)(function(iter){ Array.from(iter); }), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertObject = __webpack_require__(204).obj;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(196)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(192)
	  , setUnscope = __webpack_require__(242)
	  , ITER       = __webpack_require__(198).safe('iter')
	  , $iter      = __webpack_require__(229)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
	...
	__webpack_require__(230)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(UNSCOPABLES in []))__webpack_require__(192).hide(Array.prototype, UNSCOPABLES, {});
	module.exports = function(key){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(242)('copyWithin');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KEY    = 'find'
	  , $def   = __webpack_require__(199)
	  , forced = true
	  , $find  = __webpack_require__(202)(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KEY    = 'findIndex'
	  , $def   = __webpack_require__(199)
	  , forced = true
	  , $find  = __webpack_require__(202)(6);
	// Shouldn't skip holes
	if(KEY in [])Array(1)[KEY](function(){ forced = false; });
	$def($def.P + $def.F * forced, 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && $.DESC){
	  if(!CORRECT_NEW || !ALLOWS_RE_WITH_FLAGS){
	    ...
	    __webpack_require__(200)($.g, 'RegExp', $RegExp);
	  }
	  // 21.2.5.3 get RegExp.prototype.flags()
	  if(/./g.flags != 'g')$.setDesc(proto, 'flags', {
	    configurable: true,
	    get: __webpack_require__(206)(/^.*\/(\w*)$/, '$1')
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(192)
	  ...
	  , setProto = __webpack_require__(217).set
	  , same     = __webpack_require__(215)
	  , species  = __webpack_require__(244)
	  , SPECIES  = __webpack_require__(196)('species')
	  , RECORD   = __webpack_require__(198).safe('record')
	  , PROMISE  = 'Promise'
	  , global   = $.g
	  , process  = global.process
	  , isNode   = cof(process) == 'process'
	  , asap     = process && process.nextTick || __webpack_require__(252).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(239)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(203)
	  , get  = __webpack_require__(229).get
	  , call = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $redef = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(192)
	  , ctx      = __webpack_require__(203)
	  , safe     = __webpack_require__(198).safe
	  , assert   = __webpack_require__(204)
	  , forOf    = __webpack_require__(251)
	  , step     = __webpack_require__(229).step
	  , $has     = $.has
	  , set      = $.set
	  , isObject = $.isObject
	  , hide     = $.hide
	...
	module.exports = {
	  getConstructor: function(wrapper, NAME, IS_MAP, ADDER){
	    ...
	    __webpack_require__(253)(C.prototype, {
	  ...
	  setIter: function(C, NAME, IS_MAP){
	    __webpack_require__(230)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $     = __webpack_require__(192)
	  , $def  = __webpack_require__(199)
	  , BUGGY = __webpack_require__(229).BUGGY
	  , forOf = __webpack_require__(251)
	  , species = __webpack_require__(244)
	  , assertInstance = __webpack_require__(204).inst;
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  ...
	  function fixMethod(KEY){
	    var fn = proto[KEY];
	    __webpack_require__(200)(proto, KEY,
	  ...
	  if(!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)){
	    ...
	    __webpack_require__(253)(C.prototype, methods);
	  } else {
	    var inst  = new C
	      , chain = inst[ADDER](IS_WEAK ? {} : -0, 1)
	      , buggyZero;
	    // wrap for init collections from iterable
	    if(!__webpack_require__(239)(function(iter){ new C(iter); })){ // eslint-disable-line no-new
	  ...
	  __webpack_require__(195).set(C, NAME);
	...
	if(new $WeakMap().set((Object.freeze || Object)(tmp), 7).get(tmp) != 7){
	  $.each.call(['delete', 'has', 'get', 'set'], function(key){
	    var proto  = $WeakMap.prototype
	      , method = proto[key];
	    __webpack_require__(200)(proto, key, function(a, b){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(192)
	  ...
	  , WEAK      = safe('weak')
	  , LEAK      = safe('leak')
	  , method    = __webpack_require__(202)
	  , find      = method(5)
	  , findIndex = method(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(242)('includes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(199);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(206)(/[\\^$*+?.()|[\]{}]/g, '\\$&', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call(keys.split(','), function(key){
	    ...
	    else if(key in [])statics[key] = __webpack_require__(203)(Function.call, [][key], length);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(192)
	  , $def      = __webpack_require__(199)
	  , invoke    = __webpack_require__(201)
	  , partial   = __webpack_require__(276)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $      = __webpack_require__(192)
	  , invoke = __webpack_require__(201)
	  , assertFunction = __webpack_require__(204).fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(241);
	var $           = __webpack_require__(192)
	  , Iterators   = __webpack_require__(229).Iterators
	  , ITERATOR    = __webpack_require__(196)('iterator')
